            ...
            <div class="col-xl-12">
                ...
                <div class="offer_time">
                    <div class="wsus__flash_coundown">
                        <span class=" end_text">
                            <img style="width: 300px" src="{{ asset('frontend/images/flashicon.webp') }}" alt="">
                        </span>

                        <div class="count">
                            <span style="font-size: 13px; font-weight: 600; color: #000">Thời gian còn lại:</span>
                    ...
                    <div class="wsus__product_item">
                        ...
                        <div class="wsus__product_details">
                            ...
                            <form class="shopping-cart-form">
                                ...
                                <button type="submit" class="add_cart" href="#" style="border:none">add to
                                    cart</button>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="wsus__pro_details_text">
                                    <a class="title line-clamp" href="#">{{ $product->name }}</a>
                                    ...
                                    <form class="shopping-cart-form">
                                        ...
                                        <ul class="wsus__button_area">
                                            ...
                                            <li><a href="#" data-id="{{ $product->id }}"
                                                    class="add-wishlist"><i class="fal fa-heart"></i></a></li>
